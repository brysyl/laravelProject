...
@section ('content')
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="{{asset('/img/hero-slider/1.jpg')}}">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
			...
			<div class="hs-item set-bg" data-setbg="{{asset('/img/hero-slider/2.jpg')}}">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/1.png')}}" alt="1">
					</div>
				...
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/2.png')}}" alt="1">
					</div>
					<div class="service-content">
				...
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/3.png')}}" alt="1">
					</div>
					<div class="service-content">
						<h4>Activity Hub</h4>
						<p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue. Aenean dos cursus lania.</p>
				...
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/4.png')}}" alt="1">
					</div>
					<div class="service-content">
				...
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/5.png')}}" alt="1">
					</div>
					<div class="service-content">
				...
				<div class="col-lg-4 col-sm-6 service-item">
					<div class="service-icon">
						<img src="{{asset('/img/services-icons/6.png')}}" alt="1">
					</div>
					<div class="service-content">
						<h4>Chemistry Lab</h4>
						<p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue. Aenean dos cursus lania.</p>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 offset-lg-1 p-lg-0 p-4">
					<img src="{{asset('/img/encroll-img.jpg')}}" alt="">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/1.jpg')}}" alt="">
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/2.jpg')}}" alt="">
						<div class="course-cat">
							<span>Marketing</span>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/3.jpg')}}" alt="">
						<div class="course-cat">
							<span>DESIGN</span>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/4.jpg')}}" alt="">
						<div class="course-cat">
							<span>DATABASE</span>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/5.jpg')}}" alt="">
						<div class="course-cat">
							<span>PROGRAM</span>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 course-item">
					<div class="course-thumb">
						<img src="{{asset('/img/course/6.jpg')}}" alt="">
						<div class="course-cat">
							<span>BUSINESS</span>
						</div>
					</div>
	...
	<div class="gallery-section">
		<div class="gallery">
			...
			<div class="gallery-item gi-big set-bg" data-setbg="img/gallery/1.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/1.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="img/gallery/2.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/2.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="img/gallery/3.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/3.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-long set-bg" data-setbg="img/gallery/5.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/5.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-big set-bg" data-setbg="img/gallery/8.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/8.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item gi-long set-bg" data-setbg="img/gallery/4.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/4.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="img/gallery/6.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/6.jpg')}}"><i class="ti-plus"></i></a>
			</div>
			<div class="gallery-item set-bg" data-setbg="img/gallery/7.jpg">
				<a class="img-popup" href="{{asset('/img/gallery/7.jpg')}}"><i class="ti-plus"></i></a>
			</div>
		</div>
	</div>
	<!-- Gallery section -->
