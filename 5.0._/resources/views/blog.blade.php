		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 post-list">
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg="{{asset('/img/blog/1.jpg')}}"></div>
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg="{{asset('/img/blog/2.jpg')}}"></div>
						<div class="post-content">
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg="{{asset('/img/blog/3.jpg')}}"></div>
						<div class="post-content">
					...
					<div class="post-item">
						<div class="post-thumb set-bg" data-setbg="{{asset('/img/blog/4.jpg')}}"></div>
						<div class="post-content">
				...
				<div class="col-sm-8 col-md-5 col-lg-4 col-xl-3 offset-xl-1 offset-0 pl-xl-0 sidebar">
					...
					<div class="widget">
						...
						<div class="recent-post-widget">
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/1.jpg')}}"></div>
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/2.jpg')}}"></div>
								<div class="rp-content">
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/3.jpg')}}"></div>
								<div class="rp-content">
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/4.jpg')}}"></div>
								<div class="rp-content">
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/5.jpg')}}"></div>
								<div class="rp-content">
							...
							<!-- recent post -->
							<div class="rp-item">
								<div class="rp-thumb set-bg" data-setbg="{{asset('/img/blog/recent-post/6.jpg')}}"></div>
								<div class="rp-content">
									<h6>My MBA experience: ‘It was an eye opener’</h6>
									<p><i class="fa fa-clock-o"></i> 24 Mar 2018</p>
								</div>
